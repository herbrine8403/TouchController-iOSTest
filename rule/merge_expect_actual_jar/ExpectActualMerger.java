...
public class ExpectActualMerger extends Worker {
    private static class Environment {
        ...
        private HashMap<String, MergeEntry> preprocess(String[] args) throws IOException {
        ...
        private List<Map.Entry<String, MergeEntry>> sort(HashMap<String, MergeEntry> mergeEntries) {
        ...
        private void writeJar(List<Map.Entry<String, MergeEntry>> entries) throws IOException {
    ...
    protected int handleRequest(PrintWriter out, Path sandboxDir, String... args) throws Exception {
        new Environment().main(args);
        return 0;
    }

    public static void main(String[] args) throws Exception {
        new ExpectActualMerger().run(args);
    }
}